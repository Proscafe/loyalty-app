      ...
      <div className="relative flex h-[calc(100vh-52px)] w-full max-w-[414px] items-center justify-center border-[8px] border-[#ffd66b]">
        <div className="text-center">
          ...
          <div className="mt-2 flex items-center justify-center gap-4">
            <span className="inline-block animate-pulse text-[42px] leading-none text-[#365665]">
              ★
            </span>
            <span className="inline-block animate-pulse text-[42px] leading-none text-[#ffd66b] [animation-delay:180ms]">
              ★
            </span>
            <span className="inline-block animate-pulse text-[42px] leading-none text-[#1f3b48] [animation-delay:360ms]">
              ★
            </span>
          </div>
        </div>
